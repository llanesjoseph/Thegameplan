            ...
            <div className={`absolute ${isInIframe ? 'top-3 right-3' : 'top-6 right-6'} w-[calc(50%-0.75rem)] sm:w-[calc(33.333%-0.667rem)] lg:w-[calc(25%-0.75rem)] flex flex-col ${isInIframe ? 'gap-1.5' : 'gap-3'}`}>
              ...
              {(instagram || youtube || linkedin || facebook) && (
                ...
                >
                  ...
                  >
                    <button
                      className="w-full py-3 rounded-lg text-white text-sm font-bold transition-colors shadow-lg"
                      style={{
                  ...
                  >
                    <div className="w-full py-2.5 px-2 rounded-lg bg-black shadow-lg flex justify-center gap-2">
                      {instagram && (
                        <a
