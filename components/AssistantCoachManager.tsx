              ...
              <div key={assistant.id} className="bg-white/80 rounded-xl p-4 border border-sky-blue/10">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-green to-green/80 rounded-lg flex items-center justify-center text-white font-bold">
                      {assistant.displayName.charAt(0)}
                    </div>
                    <div>
                      <h5 className="font-bold text-dark">{assistant.displayName}</h5>
