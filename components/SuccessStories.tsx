    ...
    <section className="section-light-alt section-padding">
      <div className="container">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <div className="flex items-center justify-center lg:justify-start gap-4 mb-6">
                  ...
                  <div>
                    <h4 className="font-bold text-[var(--deep-black)]">{stories[activeStory].name}</h4>
                ...
                <div className="flex items-center justify-center lg:justify-start gap-6">
                  ...
                  <div className="text-[var(--primary-cyan)] font-bold text-lg">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16 max-w-3xl mx-auto">
          ...
          <div className="text-center">
            <div className="text-4xl font-bold gradient-text mb-2">2.8x</div>
