...
const navigationItems = {
 ...
 creator: [
  ...
  { title: 'Athletes', icon: Users, href: '/dashboard/creator/athletes', color: 'text-cyan-600' },
  { title: 'Coaching Requests', icon: MessageSquare, href: '/dashboard/creator/requests', color: 'text-purple-600' },
