...
export default function SimpleAuth() {
 ...
 return (
  <div className="space-y-3 w-full">
   ...
   {/* TEMPORARILY DISABLED: Apple Sign-In requires Apple Developer account and Service ID configuration */}
   {/* Uncomment when ready to enable Apple Sign-In */}
   {/* <button
    onClick={handleAppleSignIn}
    disabled={isLoading}
    className="w-full bg-black hover:bg-gray-900 text-white py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg  transition-all disabled:opacity-50 flex items-center justify-center gap-2 sm:gap-3 shadow-lg hover:shadow-xl transform hover:scale-[1.02] text-sm sm:text-base"
   >
