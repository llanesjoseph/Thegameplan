  ...
  return (
    <div className="space-y-3">
      <button
        ...
        disabled={isLoading}
        className="w-full bg-gradient-to-r from-sky-blue to-green hover:from-sky-blue/90 hover:to-green/90 text-white border border-sky-blue/30 py-3 px-4 rounded-lg font-semibold transition-all disabled:opacity-50 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
      >
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-orange to-deep-plum hover:from-orange/90 hover:to-deep-plum/90 text-white border border-orange/30 py-3 px-4 rounded-lg font-semibold transition-all flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
      >
