   ...
   <div className="container">
    ...
    <div className="mt-20">
     <div className="text-center mb-12">
      <h3 className="text-2xl text-[var(--deep-black)] mb-3">Trusted by thousands of users worldwide</h3>
  ...
  >
   <div className="flex items-start gap-4">
    ...
    <div className="flex-1">
     <h3 className="text-xl text-[var(--deep-black)] mb-2">{feature.title}</h3>
