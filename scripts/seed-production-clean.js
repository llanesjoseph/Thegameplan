/**
 * PRODUCTION SEED SCRIPT - CLEAN SLATE
 *
...
(async function() {
  ...
  try {
    ...
    // Initialize Firebase with CORRECT project ID
    let app
    let auth
    let db
