   ...
   <div className="relative overflow-hidden">
    ...
    <div className="absolute inset-0 opacity-10">
     <div
      ...
      style={{
       backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23333333' fill-opacity='0.1'%3E%3Ccircle cx='7' cy='7' r='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`
      }}
     ></div>
    </div>
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
     <div className="text-center mb-16">
      ...
      {/* Main Headline */}
      <h1 className="text-4xl lg:text-6xl mb-6 text-gray-800 tracking-tight">
     ...
     <div className="max-w-4xl mx-auto">
      <h2 className="text-2xl text-center text-gray-800 mb-8">What's Included</h2>
