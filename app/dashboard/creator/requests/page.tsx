   ...
   <main className="min-h-screen bg-gray-50 flex items-center justify-center">
    <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-600/30 rounded-2xl p-12 max-w-lg">
     <div className="text-center">
      ...
      <h1 className="text-2xl text-gray-900 mb-4">Creator Access Required</h1>
   ...
   <div className="max-w-7xl mx-auto">
    ...
    {!loadingRequests && items.length > 0 && (
     <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
      ...
      <div className="bg-white border border-gray-100 rounded-xl p-4">
       <div className="text-2xl text-orange-600">{items.filter(r => r.status === 'new').length}</div>
       <div className="text-gray-600 text-sm">Awaiting Response</div>
      </div>
      <div className="bg-white border border-gray-100 rounded-xl p-4">
       <div className="text-2xl text-green-600">{items.filter(r => r.status === 'accepted').length}</div>
       <div className="text-gray-600 text-sm">Accepted</div>
      </div>
      <div className="bg-white border border-gray-100 rounded-xl p-4">
       <div className="text-2xl text-cardinal">{items.filter(r => r.status === 'scheduled').length}</div>
       <div className="text-gray-600 text-sm">Scheduled</div>
      </div>
      <div className="bg-white border border-gray-100 rounded-xl p-4">
       <div className="text-2xl text-purple-600">{items.filter(r => r.status === 'completed').length}</div>
