      ...
      <main className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-600/30 rounded-2xl p-12 max-w-md">
          <div className="text-center">
            ...
            <Link 
              href="/dashboard" 
              className="inline-block px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg font-medium transition-all duration-200 shadow-lg shadow-blue-500/20"
            >
              Back to Dashboard
            </Link>
          </div>
      ...
      <main className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-600/30 rounded-2xl p-12 max-w-lg">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">This page is only available to creators. Your current role: <span className="text-blue-600">{role || 'Not set'}</span></p>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {!loadingRequests && items.length > 0 && (
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
            ...
            <div className="bg-white border border-gray-100 rounded-xl p-4">
              <div className="text-2xl font-bold text-blue-600">{items.filter(r => r.status === 'scheduled').length}</div>
                ...
                <div key={r.id} className="bg-white border border-slate-200 rounded-xl p-4 hover:shadow-md transition-all duration-200 hover:border-slate-300">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mb-4">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full bg-white border border-gray-300 rounded-lg px-3 py-2 text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                            />
                          </div>
                          <div>
                        ...
                        <div className="mb-4">
                          ...
                          <textarea
                            ...
                            rows={3}
                            className="w-full bg-white border border-gray-300 rounded-lg px-3 py-2 text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 resize-none"
                          />
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                          <button
                            ...
                            className="px-4 py-2 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg font-medium transition-all duration-200 flex items-center gap-2"
                          >
                  ...
                  {!isExpanded && schedulingCard !== r.id && (
                    <div className="mt-3 pt-3 border-t border-gray-200">
                      ...
                      {r.fileUrl && (
                        <div className="mt-2">
                          <span className="text-blue-600 text-xs">📎 Has attachment</span>
                        </div>
                      )}
                    </div>
                  )}
                      ...
                      {r.fileUrl && (
                        <div className="mt-4">
                          <a 
                            ...
                            className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 text-sm transition-colors bg-gray-50 hover:bg-gray-100 px-3 py-2 rounded-lg border border-gray-200"
                          >
                            📎 View Attachment
                          </a>
                        </div>
