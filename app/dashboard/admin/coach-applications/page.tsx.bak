      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-dark font-heading">Coach Applications</h1>
          ...
          <div className="flex gap-4">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 text-center border border-white/50">
              <div className="text-2xl font-bold text-orange">{applications.filter(a => a.status === 'pending').length}</div>
              <div className="text-sm text-dark/60">Pending</div>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 text-center border border-white/50">
              <div className="text-2xl font-bold text-green">{applications.filter(a => a.status === 'approved').length}</div>
              <div className="text-sm text-dark/60">Approved</div>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 text-center border border-white/50">
              <div className="text-2xl font-bold text-sky-blue">{applications.length}</div>
                ...
                <div key={application.id} className="p-6 hover:bg-sky-blue/5 transition-colors">
                  <div className="flex items-center justify-between">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-deep-plum to-sky-blue rounded-xl flex items-center justify-center text-white font-bold text-lg">
                        {application.displayName.charAt(0)}
                      </div>

                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <h3 className="text-lg font-bold text-dark">{application.displayName}</h3>
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="sticky top-0 bg-white/95 backdrop-blur-sm p-6 border-b border-dark/10 rounded-t-2xl">
                <div className="flex items-center justify-between">
                  <div>
                    <h2 className="text-2xl font-bold text-dark">{selectedApplication.displayName}</h2>
              ...
              <div className="p-6 space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-bold text-dark mb-4">Basic Information</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-dark mb-4">Specialties</h3>
                ...
                {/* Philosophy */}
                <div>
                  <h3 className="text-lg font-bold text-dark mb-4">Coaching Philosophy</h3>
                  <div className="bg-dark/5 rounded-xl p-6">
                    <h4 className="text-xl font-bold text-dark mb-3">{selectedApplication.applicationData.philosophy.title}</h4>
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      {selectedApplication.applicationData.philosophy.points.map((point, index) => (
                        <div key={index} className="bg-white rounded-lg p-4">
                          <h5 className="font-bold text-dark mb-2">{point.title}</h5>
                ...
                {selectedApplication.status === 'pending' && (
                  <div className="bg-cream/50 rounded-xl p-6">
                    <h3 className="text-lg font-bold text-dark mb-4">Review Application</h3>
                ...
                {selectedApplication.reviewedAt && (
                  <div className="bg-dark/5 rounded-xl p-6">
                    <h3 className="text-lg font-bold text-dark mb-4">Review History</h3>
