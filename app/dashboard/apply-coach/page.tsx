  ...
  return (
   <div className="min-h-screen bg-gradient-to-br from-cream via-cream to-sky-blue/10 flex items-center justify-center px-4">
    <div className="max-w-md mx-auto text-center">
     ...
     <h1 className="text-2xl text-dark mb-4">You're Already a Coach!</h1>
  ...
  return (
   <div className="min-h-screen bg-gradient-to-br from-cream via-cream to-sky-blue/10 flex items-center justify-center px-4">
    <div className="max-w-md mx-auto text-center">
     ...
     <h1 className="text-2xl text-dark mb-4">{config.title}</h1>
  ...
  return (
   <div className="min-h-screen bg-gradient-to-br from-cream via-cream to-sky-blue/10 flex items-center justify-center px-4">
    <div className="max-w-md mx-auto text-center">
     ...
     <h1 className="text-2xl text-dark mb-4">Application Submitted!</h1>
     <p className="text-dark/70 mb-6">
   ...
   <div className="max-w-4xl mx-auto px-6 py-8">
    ...
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-8 mb-8">
     ...
     <div className="text-center">
      <h2 className="text-xl text-dark mb-2">
        ...
        {applicationData.philosophy.points.map((point, index) => (
         <div key={index} className="mb-4 p-4 bg-white/60 rounded-xl border border-sky-blue/10">
          <div className="flex items-center gap-3 mb-3">
           <div className="w-8 h-8 bg-gradient-to-r from-sky-blue to-black rounded-lg flex items-center justify-center text-white ">
            {index + 1}
           </div>
           <input
            type="text"
