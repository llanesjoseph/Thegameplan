...
export default function AssistantCoachDashboard() {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Assistant Coach Dashboard</h1>
        ...
        <Link href="/dashboard/assistant/requests" className="group">
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-green-600 text-2xl font-bold">{stats.pendingRequests}</span>
            </div>
        ...
        <Link href="/dashboard/assistant/schedule" className="group">
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-orange-600 text-2xl font-bold">{stats.upcomingScheduled}</span>
            </div>
        ...
        <Link href="/dashboard/assistant/athletes" className="group">
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-purple-600 text-2xl font-bold">{stats.managedAthletes}</span>
            </div>
        ...
        <Link href="/dashboard/assistant/analytics" className="group">
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-pink-600 text-2xl font-bold">{stats.thisWeekActivity}</span>
            </div>
