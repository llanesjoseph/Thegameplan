    ...
    return (
      <div className="container mx-auto p-6">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <h3 className="text-yellow-800 font-semibold">No Rubric Available</h3>
          <p className="text-yellow-600 mt-2">
            No rubric has been configured for this skill. Please contact an administrator.
          </p>
        </div>
      </div>
    );
