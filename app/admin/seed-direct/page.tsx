  ...
  <div className="min-h-screen bg-gray-50">
   <div className="max-w-4xl mx-auto px-6 py-10">
    ...
    <div className="text-center mb-8">
     <h1 className="text-4xl text-gray-900 mb-4">🎯 DIRECT DATABASE SEEDING</h1>
    ...
    <div className="text-center mb-8">
     <button
      ...
      disabled={seeding}
      className={`px-12 py-6 text-2xl rounded-lg shadow-lg transform transition-all duration-200 ${
       seeding
