    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">🔥 COMPLETE DATABASE SEEDING</h1>
        ...
        <div className="text-center mb-8">
          <button
            ...
            disabled={seeding}
            className={`px-16 py-8 text-3xl font-bold rounded-lg shadow-lg transform transition-all duration-200 ${
              seeding
