...
export const metadata: Metadata = {
 title: 'Terms of Service | Athleap',
 description: 'Terms of Service for Athleap AI coaching platform'
}
  ...
  <div className="min-h-screen bg-gray-50 py-12">
   <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="bg-white shadow-lg rounded-lg p-8 lg:p-12">
     <h1 className="text-3xl text-gray-900 mb-8">Terms of Service</h1>
     ...
     <div className="prose prose-lg max-w-none">
      ...
      <section className="mb-8">
       ...
       <p className="text-gray-700 mb-4">
        By accessing or using Athleap ("the Service"), you agree to be bound by these Terms of Service ("Terms").
      ...
      <section className="mb-8">
       ...
       <p className="text-gray-700 mb-4">
        Athleap is an AI-powered sports coaching platform that provides training advice, mental performance guidance,
        ...
        <div className="flex">
         <div className="ml-3">
          <p className="text-sm text-red-700">
           Medical Disclaimer: Athleap does not provide medical advice, diagnosis, or treatment.
      ...
      <section className="mb-8">
       ...
       <ul className="list-disc list-inside text-gray-700 space-y-2">
        <li>Athleap is provided "as is" without warranties</li>
      ...
      <section className="mb-8">
       ...
       <ul className="list-disc list-inside text-gray-700 space-y-2">
        <li>Athleap owns all rights to the platform and AI models</li>
